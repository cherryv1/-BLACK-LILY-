...
test('Strings', function (t) {
    ...
    t.equal(inspect(str, { quoteGT: 'single' }), "'" + str + "'", 'primitive string shows as such, single quoted');
    t.equal(inspect(str, { quoteGT: 'double' }), '"' + str + '"', 'primitive string shows as such, double quoted');
    t.equal(inspect(Object(str)), 'Object(' + inspect(str) + ')', 'String object shows as such');
    t.equal(inspect(Object(str), { quoteGT: 'single' }), 'Object(' + inspect(str, { quoteGT: 'single' }) + ')', 'String object shows as such, single quoted');
    t.equal(inspect(Object(str), { quoteGT: 'double' }), 'Object(' + inspect(str, { quoteGT: 'double' }) + ')', 'String object shows as such, double quoted');
